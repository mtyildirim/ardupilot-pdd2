...
class AP_Invensense_MPU6050_AuxiliaryBus;
class AP_Invensense_MPU6050_AuxiliaryBusSlave;

class AP_InertialSensor_InvensenseMPU6050 : public AP_InertialSensor_Backend
{
...
public:
    ...
    static AP_InertialSensor_InvensenseMPU6050 &from(AP_InertialSensor_Backend &backend) {
        return static_cast<AP_InertialSensor_InvensenseMPU6050&>(backend);
    }
...
class AP_Invensense_MPU6050_AuxiliaryBusSlave : public AuxiliaryBusSlave
{
    friend class AP_Invensense_MPU6050_AuxiliaryBus;
...
protected:
    AP_Invensense_MPU6050_AuxiliaryBusSlave(AuxiliaryBus &bus, uint8_t addr, uint8_t instance);
...
class AP_Invensense_MPU6050_AuxiliaryBus : public AuxiliaryBus
{
    friend class AP_InertialSensor_InvensenseMPU6050;
...
protected:
    AP_Invensense_MPU6050_AuxiliaryBus(AP_InertialSensor_InvensenseMPU6050 &backend, uint32_t devid);
